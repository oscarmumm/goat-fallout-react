export const cuestionario = [
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "¿Sí? ¡Pues tú mismo con tu mecanismo!",
                skill: ["Conversación"],
            },
            {
                textoRespuesta:
                    "No digas nada, en lugar de eso, coge un tubo que tengas a mano y golpea al científico en la cabeza para dejarlo fuera de combate. Por lo que sabes, planeaba hacer estallar el refugio.",
                skill: ["CuerpoACuerpo"],
            },
            {
                textoRespuesta:
                    "En lugar de contestarle, escabúllete antes de que el científico continúe con su discurso",
                skill: ["Sigilo"],
            },
        ],
    },
    {
        ...
        opciones: [
            {
                textoRespuesta:
                    "Amputarle el pie antes de que la infección se extienda",
                skill: ["CuerpoACuerpo"],
            },
            { textoRespuesta: "Pedir ayuda a gritos", skill: ["Conversacion"] },
            {
                textoRespuesta: "Tratar la zona infectada lo mejor que sepas",
                skill: ["Medicina"],
            },
            {
                textoRespuesta:
                    "Retener al paciente y limitarte a observar cómo la infección se extiende",
                skill: ["Ciencia"],
            },
        ],
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Abrazarlo y decirle que no va a pasarle nada",
                skill: ["Conversacion"],
            },
            {
                textoRespuesta:
                    "Confiscar el objeto robado por la fuerza y dejarlo allí castigado",
                skill: ["Desarmado"],
            },
            {
                textoRespuesta:
                    "Meterle la mano en el bolsillo para recuperar el objeto robado y abandonarlo a su suerte",
                skill: ["Sigilo"],
            },
            {
                textoRespuesta:
                    "Llevar al muchacho a un lugar seguro y luego presentarlo ante el supervisor",
                skill: ["Nada"],
            },
        ],
    },
    {
        ...
        opciones: [
            ...
            { textoRespuesta: "Receptor", skill: ["ArmasGrandes"] },
            {
                textoRespuesta: "Bateador designado",
                skill: ["CuerpoACuerpo"],
            },
            {
                textoRespuesta:
                    "Ninguna. En realidad te gustaría que el refugio tuviera un equipo de fútbol",
                skill: ["Desarmado"],
            },
        ],
    },
    {
        ...
        opciones: [
            ...
            {
                textoRespuesta: "Tirarle el té a la cara a tu abuela",
                skill: ["Explosivos"],
            },
        ],
    },
    {
        ...
        opciones: [
            {
                textoRespuesta:
                    "Utilizas una horquilla para abrir la cerradura de la puerta",
                skill: ["Ganzuas"],
            },
            {
                textoRespuesta:
                    "Consigues una bomba cereza a través de un matón del refugio y revientas la puerta",
                skill: ["Explosivos", "Trueque"],
            },
            {
                textoRespuesta:
                    "Vas al arsenal, coges una pistola láser y vuelas la cerradura",
                skill: ["ArmasDeEnergia"],
            },
            {
                textoRespuesta: "Te vas y dejas que el abuelo se pudra",
                skill: ["Reparacion"],
            },
        ],
    },
    {
        ...
        opciones: [
            {
                textoRespuesta: "Una bala en el cerebro",
                skill: ["ArmasPequeñas"],
            },
            {
                textoRespuesta: "Grandes dosis de agente antimutágeno",
                skill: ["Medicina"],
            },
            {
                textoRespuesta:
    ...
    },
    {
        id: 8,
        pregunta:
            "Un compañero residente del Refugio 101 está en posesión del número 1 del cómic de Grognak el Bárbaro. Tú lo quieres. ¿Cuál es la mejor manera de conseguirlo?",
        opciones: [
            {
                textoRespuesta:
            ...
            {
                textoRespuesta: "Robar el cómic a punta de pistola",
                skill: ["ArmasPequeñas"],
            },
            {
                textoRespuesta:
